...
import { default as ChatMessage, ChatMessageProps, ChatMessageState } from '../../../../components/Chat/ChatMessage';
...
const chatMessageStyles: ComponentSlotStylesPrepared<ChatMessageProps & ChatMessageState, ChatMessageVariables> = {
  ...
  timestamp: ({ props: p, variables: v }) => ({
    ...
    ...((p.attached === 'bottom' || p.attached === true) && !p.reactionGroup && (screenReaderContainerStyles as ICSSInJSStyle))
  }),
