...
const ChatExampleInScrollableShorthand = () => {
  ...
  const items: ShorthandCollection<ChatItemProps> = [
    ...
    {
      message: <Chat.Message actionMenu={actionMenu} content="How are you?" unstable_overflow={overflow} />,
      key: 'message-4'
    },
    {
      message: <Chat.Message actionMenu={actionMenu} content="Do you want something?" unstable_overflow={overflow} />,
      key: 'message-5'
    }
  ];
