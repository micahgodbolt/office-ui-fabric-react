...
import { ICommandList, ICommandListProps } from './CommandList.Props';
...
export interface ICommandListState {
...
export class CommandList extends React.Component<ICommandListProps, ICommandListState> implements ICommandList {
  ...
  // public componentWillReceiveProps(nextProps: ICommandListProps) {
  //   this.setState(this._getStateFromProps(nextProps));
  //   this._commandItemWidths = null;
  // }

  // public componentDidUpdate(prevProps: ICommandListProps, prevStates: ICommandListState) {
  ...
  public render() {
    ...
    const { renderedItems, expandedMenuItemKey, renderedOverflowItems } = this.state;


    return (
      <div className={ css('ms-CommandList', className) } ref='commandSurface'>
  ...
  // private _getStateFromProps(nextProps: ICommandListProps) {
  //   return {
